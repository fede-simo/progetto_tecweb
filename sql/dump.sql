...
(1, 'Analisi di bilancio per Fuffaguru', '../../img/foto-corso-1.jpg', 'Investimenti', 14, 360, 'Online live', 'Leggere i numeri giusti per capire se un titolo ha senso.', 'Impari a leggere stato patrimoniale e conto economico senza farti incantare dalla fuffa. Esempi pratici e controlli rapidi per valutare aziende reali.'),
