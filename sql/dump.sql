...
(4, 'Analisi tecnica minimal', '../../img/foto-corso-4.jpg', 'Investimenti', 12, 320, 'Online live', 'Indicatori essenziali per leggere trend e livelli.', 'Usi pochi strumenti ma buoni: trendline, supporti e volumi. Meno fumo, piu disciplina.'),
(5, 'Budget Zen', '../../img/foto-corso-5.jpg', 'Risparmio', 8, 190, 'Online registrata', 'Metodi semplici per tenere le spese sotto controllo.', 'Costruisci un budget che funziona davvero e smetti di vivere a fine mese con l ansia.'),
(6, 'Spese invisibili: tagli leggeri', '../../img/foto-corso-6.jpg', 'Risparmio', 6, 160, 'Online registrata', 'Ridurre costi senza stravolgere lo stile di vita.', 'Tecniche pratiche per individuare uscite inutili e liberare liquidita senza sacrifici.'),
...
(11, 'PIR e strumenti previdenziali', '../../img/foto-corso-11.jpg', 'Previdenza', 11, 280, 'Online live', 'Strumenti utili e limiti da conoscere.', 'Guida chiara a PIR, previdenza complementare e opzioni per diversificare.'),
(12, 'TFR e scelte intelligenti', '../../img/foto-corso-12.jpg', 'Previdenza', 9, 230, 'In aula', 'Cosa fare con il TFR e perche.', 'Valuti pro e contro tra azienda e fondo, con esempi numerici semplici.');
